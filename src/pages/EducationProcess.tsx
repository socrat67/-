    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1 space-y-10">
      ...
      <div className="text-center">
        ...
        <p className="text-xs text-slate-500 max-w-xl mx-auto mt-2.5">
          Нормативний опис та структура навчання у Павлівському ліцеї відповідно до державного освітнього стандарту України.
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl border border-slate-150 dark:border-slate-800 shadow-xs">
        ...
        {activeGroup === 'programs' && (
          ...
          >
            ...
            <div className="space-y-3 text-xs text-slate-500 leading-relaxed font-light">
              <p>
                Освітній процес Павлівського ліцею розроблено на основі Типових освітніх програм, затверджених Міністерством освіти і науки України. Навчальний план охоплює три ступені освіти:
              </p>
        ...
        {activeGroup === 'calendar' && (
          ...
          >
            ...
            <div className="space-y-3 text-xs text-slate-500 leading-relaxed font-light">
              <p>
                Навчальні заняття організовуються за семестровою системою за рішенням педагогічної ради ліцею:
              </p>
        ...
        {activeGroup === 'nush' && (
          ...
          >
            ...
            <p className="text-xs text-slate-500 leading-relaxed font-light">
              НУШ – це не просто зміна підручників, це зовсім інший ментальний клімат у класі. Вся початкова ланка та 5-7 класи Павлівського ліцею навчаються за цим стандартом. Діти вчаться критично мислити, висловлювати власну позицію, не боятись робити помилки та розробляти власні спільні командні проекти з екології, дизайну та вирощування польових рослин на ліцейній дослідній ділянці.
            </p>
          </motion.div>
        )}
