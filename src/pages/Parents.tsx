            ...
            <div className="flex flex-col lg:flex-row gap-8 items-center">
              <div className="space-y-4 lg:w-2/3">
                ...
                <div className="space-y-3 text-xs text-slate-650 dark:text-slate-350 leading-relaxed font-light">
                  <p>
                    Павлівський ліцей повністю перейшов на сучасну кулінарну систему збалансованого харчування за рецептами відомого шеф-кухаря України <strong>Євгена Клопотенка</strong>. Нашим першочерговим завданням є відсутність шкідливих кондитерських жирів, надлишкової кількості цукру чи солі.
                  </p>
                  <p>
        ...
        {activeTab === 'safety' && (
          ...
          >
            ...
            <div className="space-y-3 text-xs text-slate-500 leading-relaxed font-light">
              <p>
                Ми розуміємо всю хвилю занепокоєння батьків у сучасних реаліях України. Головним принципом роботи ліцею у 2026 році є <strong>Безпека понад усе</strong>.
              </p>
              <p>
                У випадку оголошення сигналу повітряної тривоги на території Волинської області, вчителі призупиняють урок, виводять речі першої допомоги та організовано здійснюють супровід дітей у ліцейне укриття. Кожен учень має закріплене та промарковане місце сидіння. Батьки просять не намагатися забрати дитину під час тривоги з міркувань безпеки. Після відбою урок продовжується у штатному режимі.
              </p>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs pt-2">
              ...
              <div className="p-4 border rounded-xl space-y-1">
                ...
                <p className="text-slate-550">Спеціальна розслаблюючі зона у ліцеї з м’якими кріслами-мішками, затишним підсвічуванням та арт-терапевтичними матеріалами.</p>
              </div>
            </div>
          </motion.div>
        )}
        ...
        {activeTab === 'admission' && (
          ...
          >
            <div className="space-y-2">
              ...
              <p className="text-xs text-slate-500 leading-relaxed font-light">
                Для подачі електронної заяви батькам не обов’язково відвідувати секретаріат ліцею. Заповніть форму нижче – після автоматичного розгляду, вам прийде офлайн запрошення з переліком необхідних документів (копія свідоцтва, медична довідка № 086-1/о).
              </p>
            </div>
            ...
            {isSuccess ? (
              ...
              >
                ...
                <p className="text-slate-500 text-[11px] leading-relaxed">
                  Ваші дані внесено в чергу вступної кампанії ліцею. Наш заступник директора Олена Миколаївна зв’яжеться із вами телефоном для узгодження часу подачі паперових оригіналів. Дякуємо за довіру!
                </p>
              </motion.div>
            ) : (
              <form onSubmit={handleRegisterInput} className="space-y-4 pt-2">
                ...
                <div>
                  ...
                  <input 
                    ...
                    placeholder="с. Павлівка, вул. Молодіжна, б. 12"
                    className="w-full text-xs px-3.5 py-2 border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-850 rounded-lg text-slate-850 dark:text-slate-105 focus:outline-hidden"
                  />
                </div>
